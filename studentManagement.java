...
public class studentManagement {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Add Fee Details");
            System.out.println("6. View Fee Structure");
            System.out.println("7. View All Details by System ID");
            ...
            switch (choice) {
                ...
                case 2:
                    for (Fee stu : students) {
                        ((Student) stu).display(); // Calls only Student details
                    }
                    break;
